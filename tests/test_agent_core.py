...
class TestSourceSelection(unittest.TestCase):
    ...
    def test_source_scoring_considers_context(self):
        ...
        self.assertIn(DataSource.DERIVATIVES, scores)
        self.assertIn(DataSource.WHALE_MOVEMENTS, scores)
        self.assertGreater(scores[DataSource.DERIVATIVES], 0)
